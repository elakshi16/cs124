...
function Task(props) {
    ...
    return <div key={props.id}>
        <div id="task">
            ...
            <div id={"priority"}>
                <button className={"priorityButton"} onClick={e => props.onTaskFieldChange(props.id, "priority", 1)}/>
                <button className={"priorityButton"} onClick={e => props.onTaskFieldChange(props.id, "priority", 2)}/>
                <button className={"priorityButton"} onClick={e => props.onTaskFieldChange(props.id, "priority", 3)}/>
            </div>
